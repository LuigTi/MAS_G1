...
page(e3, _, Html) :-
	...
	currentTopLevel(e3), 
	% Constructing HTML page
	atomic_list_concat(['<br><div class="text-center style="font-size: 3rem;"><center><h1> This is your meal schedule for the week </h1></center></br></div>'], FirstRow),
